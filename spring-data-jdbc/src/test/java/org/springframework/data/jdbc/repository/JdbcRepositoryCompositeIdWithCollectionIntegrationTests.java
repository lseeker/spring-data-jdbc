 ...
 */
@Transactional
public class JdbcRepositoryCompositeIdWithCollectionIntegrationTests {
	...
	static class Config {
		...
		@Bean
		Class<?> testClass() {
			return JdbcRepositoryCompositeIdWithCollectionIntegrationTests.class;
		}
	...
	private static DummyEntity createDummyEntity(String id1, String id2) {
		...
		DummyEntity entity = new DummyEntity(id1, id2, "name", //
				new HashSet<ChildEntity>(Arrays.asList( //
						new ChildEntity(id1, id2, "child1", "child1"), //
						new ChildEntity(id1, id2, "child2", "child2")//
				)) //
		);
		entity.setNew(true);
	...
	static class DummyEntity implements Persistable<DummyEntityKey> {
		...
		public DummyEntity(String id1, String id2, String name, Set<ChildEntity> children) {
			this.id1 = id1;
			this.id2 = id2;
			this.name = name;
	...
	@Data
	static class ChildEntity implements Persistable<ChildEntityKey> {
		@Id String id1;
		@Id String id2;
		@Id String id3;
		...
		public ChildEntity(String id1, String id2, String id3, String name) {
			this.id1 = id1;
			this.id2 = id2;
			this.id3 = id3;
			this.name = name;
		...
		@Override
		public ChildEntityKey getId() {
			return ChildEntityKey.of(id1, id2, id3);
		}
	}
