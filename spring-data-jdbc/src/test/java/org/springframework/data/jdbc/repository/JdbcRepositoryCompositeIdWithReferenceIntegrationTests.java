 ...
 */
@Transactional
public class JdbcRepositoryCompositeIdWithReferenceIntegrationTests {
	...
	static class Config {
		...
		@Bean
		Class<?> testClass() {
			return JdbcRepositoryCompositeIdWithReferenceIntegrationTests.class;
		}
	...
	private static DummyEntity createDummyEntity(String id1, String id2) {
		...
		DummyEntity entity = new DummyEntity(id1, id2, "name", new DummyExtendEntity(id1, id2, "surname"));
		entity.setNew(true);
	...
	static class DummyEntity implements Persistable<DummyEntityKey> {
		...
		DummyExtendEntity extend;

		@Transient boolean isNew;

		public DummyEntity(String id1, String id2, String name, DummyExtendEntity extend) {
			this.id1 = id1;
			this.id2 = id2;
			this.name = name;
			this.extend = extend;
	...
	@Data
	static class DummyExtendEntity implements Persistable<DummyEntityKey> {
		@Id String id1;
		@Id String id2;
		...
		public DummyExtendEntity(String id1, String id2, String surname) {
			this.id1 = id1;
			this.id2 = id2;
